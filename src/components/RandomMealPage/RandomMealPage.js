    ...
    <>
      <Container maxW={'3xl'}>
        ...
        >
          ...
          <Text color={'gray.500'}>
            Struggle to choose what to eat?
            want to practice cooking different meals from different cultures?
            click the button to get a full overview, recipe and instructions of a random meal from anywhere in the world!
          </Text>
          <Stack
            direction={'column'}
            spacing={3}
          ...
          >
            ...
            <Box>
              ...
              >
                Click here to get a random meal
              </Text>
            </Box>
          </Stack>
        </Stack>
        {showMeal &&  <MealSection seed={seed} isLoadingData={isLoadingData} setIsLoadingData={setIsLoadingData} />}
      </Container>
    </>
  );
}
